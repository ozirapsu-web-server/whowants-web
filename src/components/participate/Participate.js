...
import { StyledClose, Btn } from "components/sharedComponents/sharedComponents";
      ...
      <>
          ...
          <ContentWrapper>
            ...
            <AmountWrapper>
              ...
              <StyledBtn
                ...
                onClick={onChange}
                value="20000"
                cur={form.amount === 20000}
              >
                {numberWithCommas(20000)}원
              </StyledBtn>
              <StyledBtn
                name="amount"
                onClick={onChange}
                value="30000"
                cur={form.amount === 30000}
              >
        ...
        <Wrapper>
          ...
          <ContentWrapper>
            ...
            <InputWrapper>
              ...
              />
              {alert.email && <Alert alert={alert.email}>{alert.email}</Alert>}
            </InputWrapper>
          </ContentWrapper>
        </Wrapper>
        <Wrapper>
        ...
        <Wrapper>
          <CommentWrapper>
            ...
            <div>
              회원의 개인정보는 당사의 개인정보 취급방침에 따라 안전하게
              보호됩니다. '회사'는 이용자들의 개인정보를 개인정보 취급방침의 '제
              2조 수집하는 개인정보의 항목, 수집방법 및 이용목적'에서 고지한
              범위 내에서 사용하며, 이용자의 사전 동의 없이는 동 범위를 초과하여
              이용하거나 원칙적으로 이용자의 개인정보를 외부에 공개하지
              않습니다.
            </div>
          </CommentWrapper>
          {alert.checked && (
            <Alert alert={alert.checked} style={{ textAlign: "right" }}>
              {alert.checked}
            </Alert>
          )}
          <TermsWrapper>
            <input
              ...
              value={form.checked}
            />
            <label htmlFor="checked">동의합니다</label>
          </TermsWrapper>
        </Wrapper>
        <Wrapper>
